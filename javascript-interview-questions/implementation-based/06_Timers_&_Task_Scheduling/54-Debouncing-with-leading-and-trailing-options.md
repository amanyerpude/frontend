...
URL : https://learnersbucket.com/examples/interview/debouncing-with-leading-and-trailing-options/

# Debouncing with leading and trailing options

Posted on [July 2, 2023](https://learnersbucket.com/examples/interview/debouncing-with-leading-and-trailing-options) | by [Prashant Yadav](https://learnersbucket.com/author/know_prashant/)
...
It is one of the classic frontend interview questions, but because the [classic debounce](https://learnersbucket.com/examples/interview/what-is-debouncing-in-javascript) has been common, nowadays its variation is asked during interviews like [debounce with immediate flag](https://learnersbucket.com/examples/interview/debounce-function-with-immediate-flag-in-javascript).
